...
#wget https://mj.ucw.cz/download/linux/pci/pciutils-3.13.0.tar.gz --continue --directory-prefix=./beyong-sources
#wget https://github.com/vcrhonek/hwdata/archive/v0.385/hwdata-0.385.tar.gz --continue --directory-prefix=./beyong-sources
...
echo "1edb865de7a2de84e67508911010091b  pciutils-3.13.0.tar.gz" | md5sum -c
echo "841090258addcaf8841f78f75eeaaadd hwdata-0.385.tar.gz" | md5sum -c
popd
