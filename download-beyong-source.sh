...
wget https://ftp.gnu.org/gnu/wget/wget-1.21.4.tar.gz --continue --directory-prefix=./sources
wget https://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-9.6p1.tar.gz --continue --directory-prefix=./sources
wget  https://github.com/libusb/libusb/releases/download/v1.0.27/libusb-1.0.27.tar.bz2 --continue --directory-prefix=./sources
wget https://kernel.org/pub/linux/utils/usb/usbutils/usbutils-017.tar.xz --continue --directory-prefix=./sources
